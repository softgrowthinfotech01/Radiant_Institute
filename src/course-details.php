...
FROM course_details
LEFT JOIN courses
ON courses.id = course_details.course_id
WHERE 1
";
...
$query .= "
ORDER BY course_details.id DESC
        ...
        <main class="flex-1 overflow-auto p-4 lg:p-8">
            ...
            <div class="container">
                ...
                <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                    ...
                    <button
                        type="button"
                        onclick="window.location.href='add-details.php'"
                                        ...
                                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                            ...
                                            <td class="px-4 py-3 lg:px-6">
                                                ...
                                                <div class="font-medium">
                                                    ...
                                                    <?php echo $detail['course_title'] ?? 'Course Deleted'; ?>
                                            ...
                                            <td class="px-4 py-3 lg:px-6 max-w-xs">

                                                <div class="line-clamp-2">

                                                    <?php echo $detail['program_highlight']; ?>
                                            ...
                                            <td class="px-4 py-3 text-right lg:px-6">
                                                ...
                                                <a
                                                    href="edit-details.php?id=<?php echo $detail['id']; ?>"
                                                ...
                                                <a
                                                    href="delete-details.php?id=<?php echo $detail['id']; ?>"
