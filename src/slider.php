            ...
            <main class="flex-1 overflow-auto p-4 lg:p-8">
                ...
                <div class="container">
                    ...
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                        ...
                        <button
                            type="button"
                            onclick="window.location.href='add-slider.php'"
                                            ...
                                            <tr class="border-b border-slate-100 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800/40">
                                                ...
                                                <td class="px-4 py-3 lg:px-6">
                                                    ...
                                                    <?php if ($slider['image']) { ?>
                                                        ...
                                                        <img
                                                            ...
                                                            class="h-16 w-28 rounded-lg border border-slate-200 object-cover dark:border-slate-700" />

                                                    <?php } else { ?>

                                                        <div class="flex h-16 w-28 items-center justify-center rounded-lg bg-slate-100 text-xs text-slate-400 dark:bg-slate-800">
                                                ...
                                                <td class="px-4 py-3 text-right lg:px-6">
                                                    ...
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        <a
                                                            href="edit-slider.php?id=<?php echo $slider['id']; ?>"
                                                        ...
                                                        <a
                                                            href="delete-slider.php?id=<?php echo $slider['id']; ?>"
