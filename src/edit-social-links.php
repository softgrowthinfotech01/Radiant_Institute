    ...
    if(isset($_FILES['images'])){
        ...
        foreach($_FILES['images']['tmp_name'] as $key => $tmp_name){
            ...
            if($_FILES['images']['error'][$key] == 0){
                ...
                move_uploaded_file(
                    $tmp_name,
                    'uploads/social-links/'.$image_name
                );

                $stmt = $conn->prepare("
                    INSERT INTO social_link_images(
                        social_link_id,
                        image
                    )
                    VALUES(
...
$social_link = $stmt->fetch(PDO::FETCH_ASSOC);

/*
|--------------------------------------------------------------------------
| GET SOCIAL LINK IMAGES
|--------------------------------------------------------------------------
*/
                            ...
                            <div class="space-y-6 p-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        name="title"
                                        required
                                        value="<?php echo $social_link['title']; ?>"
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        name="link"
                                        required
                                        value="<?php echo $social_link['link']; ?>"
                                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none ring-brand-500/30 focus:border-brand-300 focus:bg-white focus:ring-4 dark:border-slate-700 dark:bg-slate-950 dark:focus:bg-slate-950" />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows="5"
                                        required
                                        class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none ring-brand-500/30 focus:border-brand-300 focus:bg-white focus:ring-4 dark:border-slate-700 dark:bg-slate-950 dark:focus:bg-slate-950"><?php echo $social_link['description']; ?></textarea>
