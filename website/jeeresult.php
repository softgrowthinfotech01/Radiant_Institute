...
<section class="py-20 px-6 md:px-16">
  ...
  <div class="text-center mb-14">
    ...
    <p class="text-gray-600 mt-3">Consistent Excellence & Proven Results</p>
  </div>
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
    ...
    <div class="result-card p-6 rounded-2xl text-center">
      ...
      <div class="rank">98.7 Percentile</div>

      <p class="rank-number mt-2">AIR 1456</p>
      <p class="text-gray-600 text-sm">NIT Selected</p>
    </div>
    ...
    <div class="result-card p-6 rounded-2xl text-center">
      ...
      <h3 class="text-xl font-bold">Aman Verma</h3>
      <div class="rank">99.2 Percentile</div>

      <p class="rank-number mt-2">AIR 786</p>
      <p class="text-gray-600 text-sm">IIT Bombay</p>
    </div>
    ...
    <div class="result-card p-6 rounded-2xl text-center">
      ...
      <div class="rank">97.8 Percentile</div>

      <p class="rank-number mt-2">AIR 2100</p>
      <p class="text-gray-600 text-sm">Top NIT</p>
    </div>
