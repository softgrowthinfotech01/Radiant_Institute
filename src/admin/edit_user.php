...
if(isset($_POST['save'])){
    ...
    header("Location: list_user.php?msg=User Updated");
    exit;
}
?>
                            ...
                            <div class="space-y-6 p-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        id="active"
                                        value="active"
                                        class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none ring-brand-500/30 placeholder:text-slate-400 focus:border-brand-300 focus:bg-white focus:ring-4 dark:border-slate-700 dark:bg-slate-950 dark:focus:bg-slate-950" />
