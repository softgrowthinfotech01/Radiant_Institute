  <aside
    ...
    <nav class="flex-1 overflow-y-auto p-3">
      ...
      <div class="flex flex-col gap-1">
        ...
        <a href="slider" data-nav class="sidebar-link"><svg class="h-5 w-5 shrink-0 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h10" />
</svg><span class="nav-label">Slider</span></a>
