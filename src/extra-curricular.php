...
(
    ...
    WHERE activity_images.activity_id =
            ...
            <main class="flex-1 overflow-auto p-4 lg:p-8">
                ...
                <div class="container">
                    ...
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                        ...
                        <button
                            type="button"
                            onclick="window.location.href='add-extra-curricular'"
                                        ...
                                        <?php foreach($activities as $activity){ ?>
                                            ...
                                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                                ...
                                                <td class="px-4 py-3 lg:px-6">
                                                    ...
                                                    <?php if($activity['preview_image']){ ?>

                                                        <img
                                                            src="uploads/activities/<?php echo $activity['preview_image']; ?>"
                                                ...
                                                <td class="px-4 py-3 text-right lg:px-6">
                                                    ...
                                                    <a
                                                        href="edit-extra-curricular?id=<?php echo $activity['id']; ?>"
                                                    ...
                                                    <a
                                                        href="delete-extra-curricular?id=<?php echo $activity['id']; ?>"
