        ...
        <div class="container">
          <div class="mb-8 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 class="text-display-sm text-slate-900 dark:text-white">Welcome back - Softgrowth Infotech</h2>
              <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Track performance and recent activity.</p>
            </div>
            <div class="flex gap-2">
              <button type="button" onclick="window.location.href='upload_document'" class="btn btn-secondary">Share documents to users</button>
            </div>
          </div>
          ...
          <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-card transition-shadow hover:shadow-card-hover dark:border-slate-800 dark:bg-slate-900">
              ...
              <p class="mt-2 text-3xl font-semibold tracking-tight"><?= $students ?></p>
            </div>
