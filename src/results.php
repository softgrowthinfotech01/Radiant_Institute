...
(
    SELECT image
    FROM result_images
    WHERE result_images.result_id = results.id
    LIMIT 1
) as preview_image
FROM results
LEFT JOIN courses
            ...
            <main class="flex-1 overflow-auto p-4 lg:p-8">
                ...
                <div class="container">
                    ...
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                        ...
                        <button
                            type="button"
                            onclick="window.location.href='add-result.php'"
                                        ...
                                        <?php foreach ($results as $result) { ?>
                                            ...
                                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                                ...
                                                <td class="px-4 py-3 lg:px-6">
                                                    ...
                                                    <?php if ($result['preview_image']) { ?>

                                                        <img
                                                            src="uploads/results/<?php echo $result['preview_image']; ?>"
                                                ...
                                                <td class="px-4 py-3 text-right lg:px-6">
                                                    ...
                                                    <a
                                                        href="edit-result.php?id=<?php echo $result['id']; ?>"
                                                    ...
                                                    <a
                                                        href="delete-result.php?id=<?php echo $result['id']; ?>"
