<aside
    id="sidebar"
    class="fixed inset-y-0 left-0 z-40 flex w-64 -translate-x-full flex-col border-r border-slate-200 bg-white shadow-card transition-all duration-200 dark:border-slate-800 dark:bg-slate-950 lg:static lg:z-0 lg:min-h-screen lg:translate-x-0 lg:shadow-none">

    <div class="flex h-16 shrink-0 items-center gap-2 border-b border-slate-200 px-4 dark:border-slate-800">

        <span class="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-brand-600 text-sm font-bold text-white shadow-card">
            R
        </span>

        <span class="brand-text truncate text-lg font-semibold tracking-tight">
            Admin
        </span>
    ...
    <nav class="flex flex-1 flex-col overflow-y-auto p-3">
        ...
        <div class="flex flex-1 flex-col gap-1">
            ...
            <a href="index" data-nav class="sidebar-link">
            ...
            <a href="courses" data-nav class="sidebar-link">
            ...
            <a href="results" data-nav class="sidebar-link">
            ...
            <a href="extra-curricular" data-nav class="sidebar-link">
            ...
            <a href="gallery" data-nav class="sidebar-link">
            ...
            <a href="social-links" data-nav class="sidebar-link">
