...
(
    ...
    WHERE crash_course_highlights.crash_course_id = crash_courses.id
    LIMIT 1
) as preview_highlight
FROM crash_courses
WHERE 1
";
...
$crash_courses = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Crash Course — Admin</title>
            ...
            <main class="flex-1 overflow-auto p-4 lg:p-8">
                ...
                <div class="container">
                    ...
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                        ...
                        <button
                            type="button"
                            onclick="window.location.href='add-crash-course'"
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <table class="w-full min-w-[640px] text-left text-sm">
                                ...
                                <tbody>
                                    ...
                                    <?php if (count($crash_courses) > 0) { ?>

                                        <?php foreach ($crash_courses as $social_link) { ?>
                                            ...
                                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                                ...
                                                <td class="px-4 py-3 lg:px-6">
                                                    ...
                                                    <?php echo $social_link['preview_highlight']; ?>

                                                </td>

                                                <td class="px-4 py-3 lg:px-6">

                                                    <?php echo $social_link['duration']; ?>
                                                ...
                                                <td class="px-4 py-3 text-right lg:px-6">
                                                    ...
                                                    <a
                                                        href="edit-crash-course?id=<?php echo $social_link['id']; ?>"
