...
<h3 class="font-bold text-lg text-[#021969]">Concept Mastery</h3>
<p class="text-gray-600 mt-2">Deep understanding of Physics, Chemistry & Maths</p>
</div>

<div class="card bg-white p-6 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
<h3 class="font-bold text-lg text-[#021969]">Advanced Problems</h3>
<p class="text-gray-600 mt-2">JEE Main + Advanced level questions practice</p>
</div>

<div class="card bg-white p-6 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
<h3 class="font-bold text-lg text-[#021969]">AIR Strategy</h3>
<p class="text-gray-600 mt-2">Time management & rank boosting techniques</p>
</div>
...
<img src="images/iit-jee.jpg" class="rounded-2xl shadow-xl">
</div>
...
<li>✔ Daily structured classes</li>
<li>✔ Weekly + Full syllabus tests</li>
<li>✔ Doubt solving sessions</li>
<li>✔ Personal mentorship</li>
<li>✔ Study material & DPPs</li>
...
<p>Mechanics, Thermodynamics, Modern Physics</p>
</div>
...
<p>Algebra, Calculus, Coordinate Geometry</p>
</div>
