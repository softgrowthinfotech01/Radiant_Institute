...
{
    if (
        strpos($type, 'comment') !== false
    ) {
        return 'comment';
    }

    if (
        strpos($type, 'document') !== false
    ) {
        return 'document';
    }

    if (
        strpos($type, 'subtask') !== false
    ) {
        return 'subtask';
    }

    if (
        strpos($type, 'assignee') !== false
    ) {
        return 'user';
    }

    if (
        strpos($type, 'status') !== false
    ) {
        return 'status';
    }
...
<head>
    ...
    <title>
        Task Activity — <?= htmlspecialchars($task['title']) ?>
    </title>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <?php if (
                                                        ...
                                                        <p
                                                            class="mt-3 whitespace-pre-wrap text-sm leading-6 text-slate-600 dark:text-slate-300"
                                                        >
