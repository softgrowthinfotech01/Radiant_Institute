          ...
          <div class="container">
            <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
              <div class="min-w-0 flex-1">
                ...
                <h2 class="text-display-sm text-slate-900 dark:text-white">Team members</h2>
              </div>
              <button type="button" class="btn btn-primary shrink-0"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>Add user</button>
            </div>
              ...
              <div class="overflow-x-auto">
                <table class="w-full min-w-[640px] text-left text-sm">
                  <thead class="border-b border-slate-100 bg-slate-50 text-xs uppercase tracking-wide text-slate-500 dark:border-slate-800 dark:bg-slate-900/80 dark:text-slate-400">
                    <tr>
                      <th class="px-4 py-3 font-semibold lg:px-6">User</th>
                      <th class="px-4 py-3 font-semibold lg:px-6">Role</th>
                      <th class="px-4 py-3 font-semibold lg:px-6">Status</th>
                      <th class="px-4 py-3 font-semibold lg:px-6">Joined</th>
                      <th class="px-4 py-3 text-right font-semibold lg:px-6">Actions</th>
                    </tr>
                  </thead>
                  <tbody data-table-body class="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    <tr data-role="Editor" data-status="Active" class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/40">
                      <td class="px-4 py-3 lg:px-6"><div class="font-medium">Sam Wilson</div><div class="text-xs text-slate-500 dark:text-slate-400">sam.wilson@example.com</div></td>
                      <td class="px-4 py-3 lg:px-6">Editor</td>
                      <td class="px-4 py-3 lg:px-6"><span class="rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-medium text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-400">Active</span></td>
                      <td class="px-4 py-3 text-slate-600 dark:text-slate-300 lg:px-6">Feb 3, 2025</td>
                      <td class="px-4 py-3 text-right lg:px-6"><button type="button" class="btn btn-secondary px-2 py-1 text-xs">Edit</button> <button type="button" class="btn btn-secondary px-2 py-1 text-xs">More</button></td>
                    </tr>
                    <tr data-role="Viewer" data-status="Invited" class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/40">
                      <td class="px-4 py-3 lg:px-6"><div class="font-medium">Priya Sharma</div><div class="text-xs text-slate-500 dark:text-slate-400">priya@example.com</div></td>
                      <td class="px-4 py-3 lg:px-6">Viewer</td>
                      <td class="px-4 py-3 lg:px-6"><span class="rounded-full bg-amber-50 px-2.5 py-0.5 text-xs font-medium text-amber-800 dark:bg-amber-950/40 dark:text-amber-300">Invited</span></td>
                      <td class="px-4 py-3 text-slate-600 dark:text-slate-300 lg:px-6">Apr 21, 2025</td>
                      <td class="px-4 py-3 text-right lg:px-6"><button type="button" class="btn btn-secondary px-2 py-1 text-xs">Edit</button> <button type="button" class="btn btn-secondary px-2 py-1 text-xs">More</button></td>
                    </tr>
                    <tr data-role="Editor" data-status="Suspended" class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/40">
                      <td class="px-4 py-3 lg:px-6"><div class="font-medium">Chris Lee</div><div class="text-xs text-slate-500 dark:text-slate-400">chris.lee@example.com</div></td>
                      <td class="px-4 py-3 lg:px-6">Editor</td>
                      <td class="px-4 py-3 lg:px-6"><span class="rounded-full bg-red-50 px-2.5 py-0.5 text-xs font-medium text-red-700 dark:bg-red-950/40 dark:text-red-400">Suspended</span></td>
                      <td class="px-4 py-3 text-slate-600 dark:text-slate-300 lg:px-6">Nov 8, 2024</td>
                      <td class="px-4 py-3 text-right lg:px-6"><button type="button" class="btn btn-secondary px-2 py-1 text-xs">Edit</button> <button type="button" class="btn btn-secondary px-2 py-1 text-xs">More</button></td>
                    </tr>
                    <tr data-role="Admin" data-status="Active" class="transition-colors hover:bg-slate-50 dark:hover:bg-slate-800/40">
                      <td class="px-4 py-3 lg:px-6"><div class="font-medium">Taylor Brooks</div><div class="text-xs text-slate-500 dark:text-slate-400">taylor@example.com</div></td>
                      <td class="px-4 py-3 lg:px-6">Admin</td>
                      <td class="px-4 py-3 lg:px-6"><span class="rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-medium text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-400">Active</span></td>
                      <td class="px-4 py-3 text-slate-600 dark:text-slate-300 lg:px-6">Mar 30, 2025</td>
                      <td class="px-4 py-3 text-right lg:px-6"><button type="button" class="btn btn-secondary px-2 py-1 text-xs">Edit</button> <button type="button" class="btn btn-secondary px-2 py-1 text-xs">More</button></td>
                    </tr>
                  </tbody>
                </table>
