...
if($msg){
    ...
    echo "<script>window.location.href='list_title';</script>";
...
if ($search != '') {
    ...
    $countStmt = $conn->prepare("
        SELECT COUNT(*) FROM document_titles
        WHERE title LIKE ?
    ");
            ...
            <main class="flex-1 overflow-auto p-4 lg:p-8">
                ...
                <div class="container">
                    ...
                    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                        ...
                        <button
                            type="button"
                            onclick="window.location.href='create_title'"
                                            ...
                                            <tr class="border-b border-slate-100 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800/40">
                                                ...
                                                <td class="px-4 py-3 text-right lg:px-6">
                                                    ...
                                                    <div class="flex justify-end gap-2">
                                                        ...
                                                        <a
                                                            href="edit_title.php?id=<?php echo $user['id']; ?>"
                                                        ...
                                                        <a
                                                            href="delete_title.php?id=<?php echo $user['id']; ?>"
